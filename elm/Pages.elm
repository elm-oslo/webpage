...
viewAbout =
    div []
        ...
        , h3 []
            [ text "What to expect?" ]
        , p []
            [ text "A full day conference filled with interesting talks and discussions about Elm. The conference will feature a total of 18 speakers, with talks about a variety of topics. Talks will go in parallel on two tracks for parts of the day." ]
        , p []
            [ text "An conference dinner and afterparty will take place at the venue shortly after the finishing keynote. On the day before the conference, there will be a pre-conf event with workshops, an opportunity to mingle with other Elm enthusiasts before the conference, and possibly some lightning talks." ]
        , h3 []
            [ text "Why Elm?" ]
        , p []
