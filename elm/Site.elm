        ...
        [ div [ class "information-sponsors" ]
            ...
            , section [ class "information__block sponsors-gold" ]
                ...
                , p [ class "sponsor__list" ]
                    [ a [ href "https://www.bekk.no", target "_blank" ]
                        [ img [ class "sponsor__logo bekk", src "images/bekk_logo.svg" ]
                            []
                        , text "                "
                        ]
                    , a [ href "https://www.blank.no", target "_blank" ]
                        [ img [ class "sponsor__logo blank", src "images/blank_logo.svg" ]
                            []
                        , text "                "
                        ]
                    , a [ href "http://www.kodemaker.no", target "_blank" ]
                        [ img [ class "sponsor__logo kodemaker", src "images/kodemaker_logo.svg" ]
                            []
                        , text "                "
                        ]
                    , a [ href "https://www.iterate.no", target "_blank" ]
                        [ img [ class "sponsor__logo iterate", src "images/iterate.svg" ]
                            []
                        , text "                "
                        ]
                    , a [ href "https://www.knowit.no", target "_blank" ]
                        [ img [ class "sponsor__logo iterate", src "images/knowit.svg" ]
                            []
                        , text "                "
                        ]
                    ]
            ...
            , section [ class "information__block sponsors-silver" ]
                ...
                , p [ class "sponsor-forsale sponsor__list" ]
                    [ a [ href "http://arktekk.no", target "_blank" ]
                        [ img [ class "sponsor__logo arktekk", src "images/arktekk.svg" ]
                            []
                        , text "              "
                        ]
                    , a [ href "https://monokkel.io", target "_blank" ]
                        [ img [ class "sponsor__logo monokkel", src "images/monokkel.svg" ]
                            []
                        , text "              "
                        ]
                    ]
